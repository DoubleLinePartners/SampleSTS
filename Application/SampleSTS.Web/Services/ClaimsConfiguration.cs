...
namespace SampleSTS.Web.Services
{
    public class ClaimsConfiguration : ConfigurationSection
    {
        ...
        {
            return ConfigurationManager.GetSection("ClaimsConfiguration") as ClaimsConfiguration;
        }
    ...
    public class RelyingPartyCollection : ConfigurationElementCollection
    {
        ...
        {
            get { return (RelyingParty)BaseGet(index); }
        }
    }
    ...
    public class RelyingPartyClaimsCollection : ConfigurationElementCollection
    {
        ...
        {
            get { return (RelyingPartyClaim)BaseGet(index); }
        }
    }
